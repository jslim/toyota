...
import { ContactPageContentType, FilteredEntity, LocalizedPageParams, PageProps } from '@/data/types';
...
type ContactPageData = FilteredEntity<ContactPageContentType>;
...
export const getStaticProps: GetStaticProps<ContactPageProps> = async ({ params }) => {
  ...
  return {
    props: {
      head: { title: data?.fields?.pageTitle ?? 'Contact' },
